...
if __name__ == '__main__':
    ...
    parser.add_argument('--bs', type=int, default=32, help='Batch size')
    parser.add_argument('--lr', type=float, default=2e-5, help='Learning rate')
    parser.add_argument('--hallucination', action='store_true', help='Use hallucination dataset')
    args = parser.parse_args()
    ...
    train_dataset = NLIDataset(inputs_train, labels_train, tokenizer, max_length, is_hallucination=args.hallucination)
    val_dataset = NLIDataset(inputs_val, labels_val, tokenizer, max_length, is_hallucination=args.hallucination)
    test_dataset = NLIDataset(inputs_test, labels_test, tokenizer, max_length, is_hallucination=args.hallucination)
